...
set_property PACKAGE_PIN E3 [get_ports clki]							
	set_property IOSTANDARD LVCMOS33 [get_ports clki]
	create_clock -add -name sys_clk_pin -period 40.00 -waveform {0 20} [get_ports clki]
...
set_property PACKAGE_PIN C12 [get_ports reseti]				
	set_property IOSTANDARD LVCMOS33 [get_ports reseti]
#Bank = 15, Pin name = IO_L11N_T1_SRCC_15,					Sch name = BTNC
#set_property PACKAGE_PIN E16 [get_ports btnC]						
#	set_property IOSTANDARD LVCMOS33 [get_ports btnC]
#Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNU
set_property PACKAGE_PIN F15 [get_ports starti]						
	set_property IOSTANDARD LVCMOS33 [get_ports starti]
...
set_property PACKAGE_PIN B13 [get_ports {max_outo[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[0]}]
#Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports {max_outo[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[1]}]
#Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
set_property PACKAGE_PIN D17 [get_ports {max_outo[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[2]}]
#Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
set_property PACKAGE_PIN E17 [get_ports {max_outo[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[3]}]
#Bank = 15, Pin name = IO_0_15,								Sch name = JA7
set_property PACKAGE_PIN G13 [get_ports {max_outo[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[4]}]
#Bank = 15, Pin name = IO_L20N_T3_A19_15,					Sch name = JA8
set_property PACKAGE_PIN C17 [get_ports {max_outo[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[5]}]
#Bank = 15, Pin name = IO_L21N_T3_A17_15,					Sch name = JA9
set_property PACKAGE_PIN D18 [get_ports {max_outo[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[6]}]
#Bank = 15, Pin name = IO_L21P_T3_DQS_15,					Sch name = JA10
set_property PACKAGE_PIN E18 [get_ports {max_outo[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[7]}]



##Pmod Header JB
#Bank = 15, Pin name = IO_L15N_T2_DQS_ADV_B_15,				Sch name = JB1
set_property PACKAGE_PIN G14 [get_ports {max_outo[8]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[8]}]
#Bank = 14, Pin name = IO_L13P_T2_MRCC_14,					Sch name = JB2
set_property PACKAGE_PIN P15 [get_ports {max_outo[9]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[9]}]
#Bank = 14, Pin name = IO_L21N_T3_DQS_A06_D22_14,			Sch name = JB3
set_property PACKAGE_PIN V11 [get_ports {max_outo[10]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[10]}]
#Bank = CONFIG, Pin name = IO_L16P_T2_CSI_B_14,				Sch name = JB4
set_property PACKAGE_PIN V15 [get_ports {max_outo[11]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[11]}]
#Bank = 15, Pin name = IO_25_15,							Sch name = JB7
set_property PACKAGE_PIN K16 [get_ports {max_outo[12]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[12]}]
#Bank = CONFIG, Pin name = IO_L15P_T2_DQS_RWR_B_14,			Sch name = JB8
set_property PACKAGE_PIN R16 [get_ports {max_outo[13]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[13]}]
#Bank = 14, Pin name = IO_L24P_T3_A01_D17_14,				Sch name = JB9
set_property PACKAGE_PIN T9 [get_ports {max_outo[14]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[14]}]
#Bank = 14, Pin name = IO_L19N_T3_A09_D25_VREF_14,			Sch name = JB10 
set_property PACKAGE_PIN U11 [get_ports {max_outo[15]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[15]}]
 


##Pmod Header JC
#Bank = 35, Pin name = IO_L23P_T3_35,						Sch name = JC1
set_property PACKAGE_PIN K2 [get_ports {max_outo[16]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[16]}]
#Bank = 35, Pin name = IO_L6P_T0_35,						Sch name = JC2
set_property PACKAGE_PIN E7 [get_ports {max_outo[17]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {max_outo[17]}]
...
set_property PACKAGE_PIN E6 [get_ports clk_out]					
	set_property IOSTANDARD LVCMOS33 [get_ports clk_out]
#Bank = 35, Pin name = IO_L22N_T3_35,						Sch name = JC9
set_property PACKAGE_PIN J2 [get_ports start_ld_inputo]					
	set_property IOSTANDARD LVCMOS33 [get_ports start_ld_inputo]
#Bank = 35, Pin name = IO_L19P_T3_35,						Sch name = JC10
set_property PACKAGE_PIN G6 [get_ports start_ld_coeffo]					
	set_property IOSTANDARD LVCMOS33 [get_ports start_ld_coeffo]
